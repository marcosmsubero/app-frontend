...
export default function ProfileOnboardingPage() {
  ...
  async function handleVerifyLocation() {
    ...
    try {
      ...
      setForm((prev) => ({ ...prev, location: label || prev.location }));
      setLocationVerifiedDraft(true);
      setSuccess("Ubicación detectada. Guarda los cambios para dejarla verificada.");
    } catch (err) {
  ...
  const showVerifyLocationCta = isEditMode && !isGroup && !locationVerifiedDraft;
