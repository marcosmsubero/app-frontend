...
export default function ProfileOnboardingPage() {
  ...
  const draftKey = isEditMode ? "profile:onboarding:edit" : "profile:onboarding:create";
  ...
  useEffect(() => {
    ...
    const persisted = readDraftSnapshot(draftKey, null, 1);
    if (persisted) {
  ...
  async function handleUseCurrentLocation() {
    ...
    try {
      ...
      setError(error?.message || "No se pudo usar la ubicación actual.");
    } finally {
      setLocating(false);
    }
  }
      ...
      <section className="sectionBlock">
        <form className="formCard" onSubmit={handleSubmit}>
          ...
          <div className="formRow">
            ...
            />
            <div className="formActions formActions--single">
              <button
                type="button"
